...
if ($conn->query($sql) === TRUE) {
    try {
        ...
        $mail->SMTPAuth   = true;       
        // YOUR email                            
        $mail->Username   = 'hbrandin@ymail.com'; 
        // Your google app password                    
        $mail->Password   = 'bread123';                               
        $mail->SMTPSecure = 'tls';         
        $mail->Port       = 587;                                    
    
        //Recipients
        $mail->setFrom('hbrandin@ymail.com');
        $mail->addAddress('hbrandin@ymail.com');
        ...
        if (isset($_POST['replyConsent']) && $_POST['replyConsent'] === 'on') {
            ...
            $mail2->SMTPAuth   = true;    
            //Your Google email                               
            $mail2->Username   = 'hbrandin@ymail.com';    
            //Your app password                 
            $mail2->Password   = 'bread123';                               
            $mail2->SMTPSecure = 'tls';         
            $mail2->Port       = 587;                                    
        
            //Recipients
            $mail2->setFrom('hbrandin@ymail.com');
